...
@Table(
        name = "aisle",
        uniqueConstraints = {
                @UniqueConstraint(name = "uq_aisle_map_code", columnNames = {"map_id", "code"}),
                @UniqueConstraint(name = "uq_aisle_map_id", columnNames = {"map_id", "id"}),
                @UniqueConstraint(name = "uq_aisle_map_id_sector", columnNames = {"map_id", "id", "sector_id"})
        })
@Getter
@Setter
